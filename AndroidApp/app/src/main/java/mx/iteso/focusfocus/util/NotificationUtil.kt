...
import mx.iteso.focusfocus.ActivityMain
import mx.iteso.focusfocus.AppConstants
import mx.iteso.focusfocus.R
import mx.iteso.focusfocus.TimerNotificationActionReceiver
import java.text.SimpleDateFormat
import java.util.*

/**
 * Created by luisacfl on 06/05/18.
 */
class NotificationUtil {
    companion object {
        ...
        fun showTimerExpired(context: Context){
            ...
            nBuilder.setContentTitle("End of Period!")
                    .setContentText("Start again?")
                    .setContentIntent(getPendingIntentWithStack(context, ActivityMain::class.java))
        ...
        fun showTimerRunning(context: Context, stopTime: Long){
            ...
            nBuilder.setContentTitle("Timer is Running.")
                    .setContentText("End: ${df.format(Date(stopTime))}")
                    .setContentIntent(getPendingIntentWithStack(context, ActivityMain::class.java))
                    .setOngoing(true)
