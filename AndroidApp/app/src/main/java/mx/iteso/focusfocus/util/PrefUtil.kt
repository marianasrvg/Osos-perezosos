...
class PrefUtil {
    companion object {
        ...
        private const val TIMER_STATE_ID = "mx.iteso.focusfocus.timer.timer_state"
        ...
        private const val SECONDS_REMAINING_ID = "mx.iteso.focusfocus.timer.seconds_remaining"
